    ...
    try:
        ...
        if 'rate limit' in html.lower() or 'too many requests' in html.lower():
            ...
            if 'rate limit' in html.lower() or 'too many requests' in html.lower():
                ...
                send_discord_alert(webhook_url, "rate_limit", "Still rate limited after 15 minute wait. Stopping script.", target)
                sys.exit(1)
        ...
        if 'blocked' in html.lower() or 'captcha' in html.lower():
            ...
            send_discord_alert(webhook_url, "blocked", "IP or cookie has been blocked/flagged by Shodan", target)
